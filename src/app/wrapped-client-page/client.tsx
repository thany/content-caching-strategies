...
const Page: React.FC<Props> = ({ translations, customers }) => {
  return (
    <>
      ...
      <p>This is a client page that is wrapped within a server component that fetches the translations and customers on its turn, and passes them onto this client page. It is a little bit more complicated in code than a pure client page, but you might be able to see that there's no split second where data isn't available like in the pure client page.</p>
